...
#[no_mangle]
pub extern "C" fn morph_tensor_last_error() -> *const c_char {
...
#[no_mangle]
/// # Safety
/// Caller must pass a pointer that was allocated by `morph_tensor_*` APIs returning
/// a heap-allocated C string, and must not use the pointer after freeing.
pub unsafe extern "C" fn morph_tensor_string_free(ptr: *mut c_char) {
    if ptr.is_null() {
        return;
    }
...
#[no_mangle]
/// # Safety
/// The caller must pass a pointer and length originally allocated by `morph_tensor`
...
#[no_mangle]
pub extern "C" fn morph_tensor_device(spec: *const c_char) -> i64 {
    clear_error();
...
#[no_mangle]
pub extern "C" fn morph_tensor_free(handle: i64) -> c_int {
    clear_error();
    #[cfg(feature = "torch")]
    {
...
#[no_mangle]
pub extern "C" fn morph_tensor_device_free(handle: i64) -> c_int {
    clear_error();
    #[cfg(feature = "torch")]
    {
...
#[no_mangle]
pub extern "C" fn morph_tensor_randn(
...
#[no_mangle]
pub extern "C" fn morph_tensor_zeros(
    shape_json: *const c_char,
    dtype: *const c_char,
    device_handle: i64,
) -> i64 {
...
#[no_mangle]
pub extern "C" fn morph_tensor_matmul(a: i64, b: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
...
#[no_mangle]
pub extern "C" fn morph_tensor_add(a: i64, b: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let a = match get_tensor(a) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_mul(a: i64, b: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let a = match get_tensor(a) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_reshape(x: i64, shape_json: *const c_char) -> i64 {
    clear_error();
    let shape_json = match cstr_to_string(shape_json) {
        Ok(v) => v,
        Err(err) => {
...
#[no_mangle]
pub extern "C" fn morph_tensor_transpose(x: i64, dim0: i64, dim1: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_concat(handles_json: *const c_char, dim: i64) -> i64 {
    clear_error();
...
#[no_mangle]
pub extern "C" fn morph_tensor_sum(x: i64, dim: i64, keepdim: c_int) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_mean(x: i64, dim: i64, keepdim: c_int) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_softmax(x: i64, dim: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_masked_softmax(
    x: i64,
    mask: i64,
    dim: i64,
    mask_type: c_int,
...
#[no_mangle]
pub extern "C" fn morph_tensor_masked_softmax_backward(
    grad_output: i64,
    output: i64,
    mask: i64,
    dim: i64,
...
#[no_mangle]
pub extern "C" fn morph_tensor_relu(x: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_sigmoid(x: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_dropout(x: i64, p: f64, train: c_int) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_slice(x: i64, dim: i64, start: i64, end: i64, step: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_view(x: i64, shape_json: *const c_char) -> i64 {
    clear_error();
    let shape_json = match cstr_to_string(shape_json) {
        Ok(v) => v,
        Err(err) => {
...
#[no_mangle]
pub extern "C" fn morph_tensor_gelu(x: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_layernorm(x: i64, w: i64, b: i64, eps: f64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_layernorm_backward(
    x: i64,
    w: i64,
    b: i64,
    eps: f64,
...
#[no_mangle]
pub extern "C" fn morph_tensor_embedding(w: i64, ids: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let w = match get_tensor(w) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_linear(x: i64, w: i64, b: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_to_device(x: i64, device: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_to_dtype(x: i64, dtype: *const c_char) -> i64 {
    clear_error();
    let dtype = match cstr_to_string(dtype) {
        Ok(v) => v,
        Err(err) => {
...
#[no_mangle]
pub extern "C" fn morph_tensor_shape(x: i64) -> FfiSlice {
    clear_error();
    #[cfg(feature = "torch")]
    {
        let x = match get_tensor(x) {
...
#[no_mangle]
pub extern "C" fn morph_tensor_cross_entropy(logits: i64, targets: i64) -> i64 {
    clear_error();
    #[cfg(feature = "torch")]
    {
...
#[no_mangle]
pub extern "C" fn morph_tensor_backward(loss: i64) -> c_int {
    clear_error();
    #[cfg(feature = "torch")]
    {
...
#[no_mangle]
pub extern "C" fn morph_tensor_adamw_step(
    param: i64,
    grad: i64,
    state: i64,
    lr: f64,
        ...
        let mut slot = match state_obj.slots.remove(&param) {
            ...
            None => {
                if state_obj.slots.len() == 1 && state_obj.slots.contains_key(&0) {
                    ...
                    set_error("Optimizer state is indexed; use morph_tensor_load_sharded_opt_multi to bind params");
                    return 0;
                } else {
...
#[no_mangle]
pub extern "C" fn morph_tensor_adamw_step_multi(
...
#[no_mangle]
pub extern "C" fn morph_tensor_opt_free(handle: i64) -> c_int {
    clear_error();
    #[cfg(feature = "torch")]
    {
...
#[no_mangle]
pub extern "C" fn morph_tensor_save_sharded(
    dir: *const c_char,
    param: i64,
    opt_state: i64,
...
#[no_mangle]
pub extern "C" fn morph_tensor_save_sharded_multi(
    dir: *const c_char,
    params_json: *const c_char,
    opt_state: i64,
    meta_json: *const c_char,
...
#[no_mangle]
pub extern "C" fn morph_tensor_load_sharded(dir: *const c_char) -> i64 {
    clear_error();
    let dir = match cstr_to_string(dir) {
        Ok(v) => v,
        Err(err) => {
...
#[no_mangle]
pub extern "C" fn morph_tensor_load_sharded_params(dir: *const c_char) -> FfiSlice {
    clear_error();
    let dir = match cstr_to_string(dir) {
        Ok(v) => v,
        Err(err) => {
...
#[no_mangle]
pub extern "C" fn morph_tensor_load_sharded_opt(dir: *const c_char) -> i64 {
    clear_error();
    let dir = match cstr_to_string(dir) {
        Ok(v) => v,
        Err(err) => {
...
#[no_mangle]
pub extern "C" fn morph_tensor_load_sharded_opt_multi(
    dir: *const c_char,
    params_json: *const c_char,
) -> i64 {
    clear_error();
...
#[no_mangle]
pub extern "C" fn morph_tensor_load_sharded_meta(dir: *const c_char) -> FfiSlice {
    clear_error();
    let dir = match cstr_to_string(dir) {
        Ok(v) => v,
        Err(err) => {
