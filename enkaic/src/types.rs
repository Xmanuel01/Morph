...
pub enum Type {
    ...
    Array(Box<Type>),
    Vector(Box<Type>),
    SparseVectorOf(Box<Type>),
    TensorOf(Box<Type>, Option<usize>),
    List(Box<Type>),
    Void,
    Optional(Box<Type>),
...
impl Type {
    pub fn display(&self) -> String {
        match self {
            ...
            Type::Array(inner) => format!("Array[{}]", inner.display()),
            Type::Vector(inner) => format!("Vector[{}]", inner.display()),
            Type::SparseVectorOf(inner) => format!("SparseVector[{}]", inner.display()),
            Type::TensorOf(inner, Some(rank)) => format!("Tensor[{}, {}]", inner.display(), rank),
            Type::TensorOf(inner, None) => format!("Tensor[{}]", inner.display()),
