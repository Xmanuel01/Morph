...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Verify the strict-selfhost systems and CLI surface."
    )
    parser.add_argument(
        "--contract",
        default="enkai/contracts/selfhost_systems_and_cli_v3_3_0.json",
        help="Path to the systems-and-cli contract JSON",
    )
    parser.add_argument(
        "--output",
        default="artifacts/readiness/strict_selfhost_systems_and_cli_surface.json",
