...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Verify the v3.4.0 capability-reporting normalization baseline."
    )
    parser.add_argument(
        "--contract",
        default="enkai/contracts/v3_4_0_capability_reporting_baseline.json",
        help="Path to the v3.4.0 capability-reporting contract JSON",
    )
    parser.add_argument(
        "--output",
        default="artifacts/readiness/v3_4_0_capability_reporting_baseline.json",
