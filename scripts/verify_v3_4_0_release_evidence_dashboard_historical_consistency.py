...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Verify the v3.4.0 release-evidence/dashboard historical-consistency scope."
    )
    parser.add_argument(
        "--contract",
        default="enkai/contracts/v3_4_0_release_evidence_dashboard_historical_consistency.json",
        help="Path to the v3.4.0 release-evidence/dashboard contract JSON",
    )
    parser.add_argument(
        "--output",
        default="artifacts/readiness/v3_4_0_release_evidence_dashboard_historical_consistency.json",
