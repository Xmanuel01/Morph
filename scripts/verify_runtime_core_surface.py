...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Verify the strict-selfhost runtime core surface."
    )
    parser.add_argument(
        "--contract",
        default="enkai/contracts/selfhost_runtime_core_v3_3_0.json",
        help="Path to the runtime core contract JSON",
    )
    parser.add_argument(
        "--output",
        default="artifacts/readiness/strict_selfhost_runtime_core_surface.json",
