...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Verify the strict-selfhost compiler frontend surface."
    )
    parser.add_argument(
        "--contract",
        default="enkai/contracts/selfhost_compiler_frontend_v3_3_0.json",
        help="Path to the compiler frontend contract JSON",
    )
    parser.add_argument(
        "--output",
        default="artifacts/readiness/strict_selfhost_compiler_frontend_surface.json",
