...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Verify the v3.4.0 zero-Rust next-step baseline scope."
    )
    parser.add_argument(
        "--contract",
        default="enkai/contracts/v3_4_0_zero_rust_next_step_baseline.json",
        help="Path to the v3.4.0 zero-Rust next-step contract JSON",
    )
    parser.add_argument(
        "--output",
        default="artifacts/readiness/v3_4_0_zero_rust_next_step_baseline.json",
