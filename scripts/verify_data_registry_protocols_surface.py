...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Verify the strict-selfhost data registry/protocols surface."
    )
    parser.add_argument(
        "--contract",
        default="enkai/contracts/selfhost_data_registry_protocols_v3_3_0.json",
        help="Path to the data-registry contract JSON",
    )
    parser.add_argument(
        "--output",
        default="artifacts/readiness/strict_selfhost_data_registry_protocols_surface.json",
