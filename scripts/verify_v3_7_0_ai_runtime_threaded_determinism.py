...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Verify the v3.7.0 threaded acceleration determinism surface.")
    parser.add_argument("--contract", default="enkai/contracts/v3_7_0_ai_runtime_threaded_determinism.json")
    parser.add_argument("--output", default="artifacts/readiness/v3_7_0_ai_runtime_threaded_determinism_verify.json")
