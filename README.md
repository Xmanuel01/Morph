...
This repository contains the v2.1.7 implementation in Rust.
...
- Compatibility/deprecation governance and self-host fallback workflow docs for v2.1.7 release readiness
- Version-neutral release pipeline, deterministic packaging, checksum verification, SBOM generation, and RC evidence-archive gates for v2.1.7 sign-off
...
- Strict-contract enforcement in v2.1.7:
