# Enkai Language Specification (v0.1 -> v2.3.5)

Status: stable.
Grammar and CLI contracts are frozen at the v0.9.3 baseline for the v1.x/v2.x line.
This document is the normative language and runtime surface for Enkai v2.3.5,
...
- Built-in runtime modules shipped in v2.3.5.
...
-------------------------------------------------------------------------------
1.2 Validation Gate Status (v2.3.5)
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
10. Built-in Runtime Modules (v2.3.5)
-------------------------------------------------------------------------------
...
`std::analysis` additive APIs (v2.3.5):
...
Tensor backend (`std::tensor`, v2.3.5 surface):
...
- In v2.3.5, train/eval run strict contracts by default.
...
- Official v2.3.5 bounded claim suite: `official_v2_3_0_matrix`.
...
- v2.3.5 strict behavior rejects configs missing `config_version`.
...
- Model lifecycle control is local-filesystem scoped (`enkai model register|load|unload|promote|retire|rollback`).
  Remote registry replication and signed artifact exchange are out of scope in v2.3.5.
...
For any language/runtime surface change after v2.3.5:
