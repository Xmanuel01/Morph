# Enkai Bootstrap Subset (v1.8)

## Purpose

This document defines the stable subset used for bootstrap-lite tooling in v1.8.0.
...
The following are intentionally excluded from bootstrap-lite scripts in v1.8.0:
