# Enkai Bootstrap Subset (v1.9.6)

## Purpose

This document defines the stable subset used for bootstrap-lite tooling in v1.9.6.
...
The following are intentionally excluded from bootstrap-lite scripts in v1.9.6:
