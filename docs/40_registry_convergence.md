# 40. Registry Convergence (v2.8.0)

This document defines the `v2.8.0` convergence contract between LLM run artifacts,
...
Additive model-registry commands in `v2.8.0`:
