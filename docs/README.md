...
- Current production release line: `v2.3.4`.
- `docs/Enkai.spec` is the normative language reference for `v2.3.4`.
- Known limits and partial features are tracked inside `docs/Enkai.spec` under `Known Limits in v2.3.4`.
