...
- Current production release line: `v2.1.1`.
- `docs/Enkai.spec` is the normative language reference for `v2.1.1`.
- Known limits and partial features are tracked inside `docs/Enkai.spec` under `Known Limits in v2.1.1`.
...
5. `docs/33_benchmark_suite.md`, `docs/34_model_lifecycle.md`, `docs/35_data_algo_stack.md` (benchmark policy + model lifecycle + data/algo foundation)
