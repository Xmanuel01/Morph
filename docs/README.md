...
- Current production release line: `v2.9.0`.
- `docs/Enkai.spec` is the normative language reference for `v2.9.0`.
- Known limits and partial features are tracked inside `docs/Enkai.spec` under `Known Limits in v2.9.0`.
...
- `docs/41_scale_reliability.md` defines the `v2.9.0` scale/reliability contract for supervised simulation clusters and degraded registry fallback.
...
5. `docs/33_benchmark_suite.md`, `docs/34_model_lifecycle.md`, `docs/35_data_algo_stack.md`, `docs/36_capability_complete_report.md`, `docs/37_readiness_matrix.md`, `docs/39_adam0_reference_stack.md`, `docs/42_agi_runbook.md`, `docs/43_llm_runbook.md`, `docs/44_native_extension_abi_policy.md`, `docs/45_deployment_rollback_runbook.md`, `docs/46_benchmark_profiling_guide.md` (benchmark policy + model lifecycle + data/algo foundation + release evidence sign-off + production readiness gates + Adam-0 bounded reference suite + v3.0.0 runbooks/policy guides)
