...
- Current production release line: `v2.5.4`.
- `docs/Enkai.spec` is the normative language reference for `v2.5.4`.
- Known limits and partial features are tracked inside `docs/Enkai.spec` under `Known Limits in v2.5.4`.
