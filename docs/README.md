...
- Current production release line: `v1.2.0`.
- `docs/Enkai.spec` is the normative language reference for `v1.2.0`.
- Known limits and partial features are tracked inside `docs/Enkai.spec` under `Known Limits in v1.2.0`.
