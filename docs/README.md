...
- Current production release line: `v2.9.6`.
- `docs/Enkai.spec` is the normative language reference for `v2.9.6`.
- Known limits and partial features are tracked inside `docs/Enkai.spec` under `Known Limits in v2.9.5`.
...
- `docs/41_scale_reliability.md` defines the `v2.9.6` scale/reliability contract for supervised simulation clusters and degraded registry fallback.
