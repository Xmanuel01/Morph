...
- Current release line: `v3.0.0` (`CPU-complete / GPU operator sign-off pending`).
- `docs/Enkai.spec` is the normative language reference for `v3.0.0`.
- Known limits and partial features are tracked inside `docs/Enkai.spec` under `Known Limits in v3.0.0`.
