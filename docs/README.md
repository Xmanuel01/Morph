...
- Current production release line: `v2.1.8`.
- `docs/Enkai.spec` is the normative language reference for `v2.1.8`.
- Known limits and partial features are tracked inside `docs/Enkai.spec` under `Known Limits in v2.1.8`.
